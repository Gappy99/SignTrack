...
using AuthServiceSignTrack.Application.Exceptions;
using AuthServiceSignTrack.Application.Extensions;
using AuthServiceSignTrack.Application.Validators;
using AuthServiceSignTrack.Domain.Constants;
using AuthServiceSignTrack.Domain.Entities;
using AuthServiceSignTrack.Domain.Interfaces;
using AuthServiceSignTrack.Domain.Enums;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using AuthServiceSignTrack.Application.DTOs.Email;

namespace AuthServiceSignTrack.Application.Services;
