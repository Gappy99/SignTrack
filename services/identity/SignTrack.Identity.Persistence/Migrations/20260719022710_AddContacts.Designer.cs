...
namespace SignTrack.Identity.Persistence.Migrations
{
    ...
    [Migration("20260719022710_AddContacts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignTrack.Identity.Domain.Entities.Contact", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
                    ...
                    b.HasIndex("ContactUserId")
                        .HasDatabaseName("ix_contacts_contact_user_id");

                    b.HasIndex("UserId", "ContactUserId")
                        .IsUnique()
                        .HasDatabaseName("ix_contacts_user_id_contact_user_id");
            ...
            modelBuilder.Entity("SignTrack.Identity.Domain.Entities.Contact", b =>
                {
                    b.HasOne("SignTrack.Identity.Domain.Entities.User", "ContactUser")
                        .WithMany()
                        .HasForeignKey("ContactUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_contacts_users_contact_user_id");
